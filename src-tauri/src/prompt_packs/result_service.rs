...
pub(crate) async fn get_prompt_pack_result_in_pool(
    pool: &SqlitePool,
    run_id: i64,
...
pub(crate) async fn list_prompt_pack_stage_artifacts_in_pool(
    pool: &SqlitePool,
    stage_run_id: i64,
...
pub(crate) async fn get_prompt_pack_stage_artifact_in_pool(
    pool: &SqlitePool,
    stage_run_id: i64,
...
pub(crate) async fn get_prompt_pack_validation_findings_in_pool(
    pool: &SqlitePool,
    run_id: i64,
...
pub(crate) async fn list_prompt_pack_audit_events_in_pool(
    pool: &SqlitePool,
    run_id: i64,
