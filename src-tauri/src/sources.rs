...
use self::topics::refresh_forum_topics;
use self::types::{now_secs, SourceRecordRow, TELEGRAM_KIND_CHANNEL, TELEGRAM_SOURCE_TYPE};
...
mod tests {
    use super::{
        decode_source_metadata, determine_sync_policy, finalize_sync, load_source, SourceRecordRow,
        SourceSyncTarget, TELEGRAM_KIND_CHANNEL, TELEGRAM_SOURCE_TYPE,
    };
