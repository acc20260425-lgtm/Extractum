...
pub(crate) async fn build_youtube_summary_canonical_result(
    ...
    Ok(serde_json::json!({
        ...
        "created_at": extractum_core::time::now_rfc3339_utc(),
...
mod tests {
    ...
    use crate::youtube_summary::gem_analysis::assemble_gem_analysis_transcript_output;
    use crate::youtube_summary::outputs::execute_transcript_analysis_stage_with_completion;
    use crate::youtube_summary::test_support::{
        test_pool_with_frozen_youtube_summary_run, transcript_analysis_stage_id,
    };
    use crate::youtube_summary::LlmCompletion;
