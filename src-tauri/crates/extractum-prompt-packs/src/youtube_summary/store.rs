...
use crate::dto::PromptPackRunSummaryDto;
...
pub(crate) async fn ensure_pack_version(pool: &SqlitePool) -> AppResult<i64> {
    ...
    crate::seed::seed_builtin_prompt_packs_in_pool(pool).await?;
    crate::store::require_prompt_pack_version_id(pool, "youtube_summary", "1.0.0").await
}
