...
- [x] **Step 1: Replace all four revisions**
...
- [x] **Step 2: Run the production compiler RED**
...
- [x] **Step 3: Review lockfile scope**
...
- [x] **Step 1: Add the shared session-error conversion**
...
- [x] **Step 2: Adapt the session serialization boundary**
...
- [x] **Step 3: Make peer caching fail closed**
...
- [x] **Step 4: Preserve avatar best-effort behavior**
...
- [x] **Step 5: Preserve the missing-DC diagnostic**
...
- [x] **Step 6: Run the production GREEN check**
...
- [x] **Step 1: Add the explicit non-fallback branch and runtime assertion**
...
- [x] **Step 2: Check the production target**
...
- [x] **Step 1: Run the fixture compiler RED**
...
- [x] **Step 2: Add neutral values required by the generated structs**
...
- [x] **Step 3: Adapt all session-facing tests in one pass**
...
- [x] **Step 4: Run the test-target compiler GREEN check**
...
- [x] **Step 5: Run all four narrow compatibility tests**
...
- [x] **Step 1: Update the two source revision constants**
...
- [x] **Step 2: Regenerate, do not hand-edit, the JSON baseline**
...
- [x] **Step 3: Audit requested-feature policy**
...
- [x] **Step 4: Update the dependency policy record**
...
- [x] **Step 5: Run repository-rule GREEN checks**
...
- [x] **Step 1: Format only the affected Rust package**
...
- [x] **Step 2: Run the package checkpoint**
...
- [x] **Step 3: Prove the production surface without default features**
...
- [x] **Step 4: Run the full Rust-slice gate**
...
- [x] **Step 5: Review the pre-evidence migration diff**
...
- [x] **Step 1: Start the MCP-enabled Tauri application with the project workflow**
...
- [x] **Step 2: Exercise one live-sync source**
...
- [x] **Step 3: Exercise one Takeout path**
...
- [x] **Step 5: Append the new evidence pointer to `docs/project.md`**
...
- [x] **Step 1: Commit the remaining verified evidence**
...
- [x] **Step 2: Report completion evidence**
